...
describe("Test the Google homepage", () => {
  ...
  test('can serch google for puppies and click on the images tab and make sure we get redurected to the correct page', async () => {
      // navitgate to google.com
      await driver.get('https://www.google.com')
      
      //locate the search bar
      await driver.findElement(By.name("q")).sendKeys("puppies", Key.RETURN)
      //wait until the page changes to include the puppies 
