// require the dotenv npm and desrtucture CONNECTION_STRING from it 
require('dotenv').config();
const {CONNECTION_STRING} = process.env
//require sequelize as a class
const Sequelize = require('sequelize')
// set up a new instance of sequelize, connecting to the db
...
// to simulate a logged in user FERN
const userId = 4;
const clientId = 3;
